...
output = []
append_state_percent(state_lang_df, state_census_df, output, type="21")
output.sort(key=lambda x:x[-1])
lower_ratio21 = output[0:3]
higher_ratio21 = output[-3:]
higher_ratio21.reverse()

# 
# WRITE TO CSV HIGHERR RATIO, THEN LOWER RATIO
header_row = ["state/ut"]
write_to_csv(higher_ratio21+lower_ratio21, "output/2-to-1-ratio.csv", header_row)